  ...
  <div class="w-full flex flex-col items-center gap-24">
    ...
    <section class="pt-10 w-10/12 text-center space-y-8 text-gray-300">
      ...
      <p class="text-lg leading-relaxed">
        Mentoria gratuita e consciente para quem está começando — sem promessas mágicas, sem pagar
        caro.
      </p>
        ...
        <template #content="{ item }">
          <div class="min-w-full">
            <div class="w-full flex items-center justify-center py-10">
              <span class="text-2xl font-semibold text-neutral">{{ item?.content }}</span>
            </div>
          </div>
        </template>
      </UStepper>
    ...
    >
      <div class="w-11/12 flex flex-col gap-4">
        ...
        <NuxtLink to="/about">
          <UButton class="cursor-pointer text-base" variant="subtle" color="primary">
            Saiba mais
          </UButton>
        </NuxtLink>
      </div>
      ...
      <div class="grid grid-cols-12">
        ...
        <div class="col-span-12 lg:col-span-8 text-center flex items-center">
          <p class="h-fit text-justify">
            Gabriel Max - Sou desenvolvedor de software com mais de seis anos de experiência em
            criação de aplicações escaláveis e acessíveis. Ao longo da minha trajetória, descobri
            que o maior diferencial de um bom profissional não é apenas a técnica, mas também a
            vontade genuína de construir algo que faça diferença na vida das pessoas. Foi com essa
            motivação que nasceu a pros4noobs — uma iniciativa para democratizar a entrada no mundo
            da tecnologia de forma ética, transparente e gratuita. Acredito que orientação
            verdadeira deve ser acessível a todos, e que ninguém deveria ser impedido de começar por
            falta de recursos ou por promessas vazias. Aqui, cada mentor e cada noob fazem parte de
            algo maior: a construção de um futuro mais justo, onde conhecimento e oportunidade andam
            lado a lado. Seja muito bem-vindo à pros4noobs!
          </p>
        </div>
      </div>
    </section>
